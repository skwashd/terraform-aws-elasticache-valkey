...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | VPC ID the ElastiCache cluster is deployed into. Must match the VPC of the provided subnets. Only needed if subnets are from a different account. | `string` | `""` | no |
